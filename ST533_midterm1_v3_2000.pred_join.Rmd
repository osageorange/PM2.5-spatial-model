...
# for (i in 1:nrow(fl.area)) {
#   fl.area[i, ][fl.area[i, ] == -9999] <- 0
# }
# for (i in 1:nrow(fl.house)) {
#   fl.house[i, ][fl.house[i, ] == -9999] <- 0
# }
# for (i in 1:nrow(fl.pop)) {
#   fl.pop[i, ][fl.pop[i, ] == -9999] <- 0
# }
# for (i in 1:nrow(ga.area)) {
#   ga.area[i, ][ga.area[i, ] == -9999] <- 0
# }
# for (i in 1:nrow(ga.house)) {
#   ga.house[i, ][ga.house[i, ] == -9999] <- 0
# }
# for (i in 1:nrow(ga.pop)) {
#   ga.pop[i, ][ga.pop[i, ] == -9999] <- 0
# }
# for (i in 1:nrow(nc.area)) {
#   nc.area[i, ][nc.area[i, ] == -9999] <- 0
# }
# for (i in 1:nrow(nc.house)) {
#   nc.house[i, ][nc.house[i, ] == -9999] <- 0
# }
# for (i in 1:nrow(nc.pop)) {
#   nc.pop[i, ][nc.pop[i, ] == -9999] <- 0
# }
# for (i in 1:nrow(sc.area)) {
#   sc.area[i, ][sc.area[i, ] == -9999] <- 0
# }
# for (i in 1:nrow(sc.house)) {
#   sc.house[i, ][sc.house[i, ] == -9999] <- 0
# }
# for (i in 1:nrow(sc.pop)) {
#   sc.pop[i, ][sc.pop[i, ] == -9999] <- 0
# }
# for (i in 1:nrow(va.area)) {
#   va.area[i, ][va.area[i, ] == -9999] <- 0
# }
# for (i in 1:nrow(va.house)) {
#   va.house[i, ][va.house[i, ] == -9999] <- 0
# }
# for (i in 1:nrow(va.pop)) {
#   va.pop[i, ][va.pop[i, ] == -9999] <- 0
# }
# 
# #Replace missing value -99999 with NA
# for (i in 1:nrow(fl.area)) {
#   fl.area[i, ][fl.area[i, ] == -9999] <- NA
# }
# for (i in 1:nrow(fl.house)) {
#   fl.house[i, ][fl.house[i, ] == -9999] <- NA
# }
# for (i in 1:nrow(fl.pop)) {
#   fl.pop[i, ][fl.pop[i, ] == -9999] <- NA
# }
# for (i in 1:nrow(ga.area)) {
#   ga.area[i, ][ga.area[i, ] == -9999] <- NA
# }
# for (i in 1:nrow(ga.house)) {
#   ga.house[i, ][ga.house[i, ] == -9999] <- NA
# }
# for (i in 1:nrow(ga.pop)) {
#   ga.pop[i, ][ga.pop[i, ] == -9999] <- NA
# }
# for (i in 1:nrow(nc.area)) {
#   nc.area[i, ][nc.area[i, ] == -9999] <- NA
# }
# for (i in 1:nrow(nc.house)) {
#   nc.house[i, ][nc.house[i, ] == -9999] <- NA
# }
# for (i in 1:nrow(nc.pop)) {
#   nc.pop[i, ][nc.pop[i, ] == -9999] <- NA
# }
# for (i in 1:nrow(sc.area)) {
#   sc.area[i, ][sc.area[i, ] == -9999] <- NA
# }
# for (i in 1:nrow(sc.house)) {
#   sc.house[i, ][sc.house[i, ] == -9999] <- NA
# }
# for (i in 1:nrow(sc.pop)) {
#   sc.pop[i, ][sc.pop[i, ] == -9999] <- NA
# }
# for (i in 1:nrow(va.area)) {
#   va.area[i, ][va.area[i, ] == -9999] <- NA
# }
# for (i in 1:nrow(va.house)) {
#   va.house[i, ][va.house[i, ] == -9999] <- NA
# }
# for (i in 1:nrow(va.pop)) {
#   va.pop[i, ][va.pop[i, ] == -9999] <- NA
# }

# nc.pop.mat <- ((as.matrix(nc.pop)))
# sort(apply(nc.pop, 1, FUN = function(x) max(na.omit(x))))
# 
# fl.pop.mat <- ((as.matrix(fl.pop)))
# sort(apply(fl.pop, 1, FUN = function(x) max(na.omit(x))))
# sort(fl.pop.mat, decreasing = T)
```
